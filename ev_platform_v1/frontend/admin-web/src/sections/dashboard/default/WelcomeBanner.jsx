      ...
      <Grid container>
        <Grid size={{ md: 6, sm: 6, xs: 12 }}>
          <Stack sx={{ gap: 2, padding: 3 }}>
            <Typography variant="h2">Welcome to Quantum EV</Typography>
            <Typography variant="h6">
              Manage your EV infrastructure efficiently with our powerful admin dashboard.
            </Typography>
            <Box sx={{ pt: 1.5 }}>
              <Button
                variant="outlined"
                color="secondary"
                href="http://quantuminfosecurity.in/"
                sx={{
                  color: 'background.paper',
                ...
                target="_blank"
              >
                Product of Quantum infosecurity
              </Button>
            </Box>
          </Stack>
        </Grid>
