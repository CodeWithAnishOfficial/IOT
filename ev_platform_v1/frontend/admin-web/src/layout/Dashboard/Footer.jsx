...
export default function Footer() {
  return (
    <Stack direction="row" sx={{ justifyContent: 'space-between', alignItems: 'center', p: '24px 16px 0px', mt: 'auto' }}>
      <Typography variant="caption">&copy; Quantum EV crafted with ♥ by Quantum Tech Team</Typography>
      <Stack direction="row" sx={{ gap: 1.5, justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <Link component={RouterLink} to="http://quantuminfosecurity.in/" target="_blank" variant="caption" color="text.primary">
          Documentation
        </Link>
        <Link component={RouterLink} to="http://quantuminfosecurity.in/" target="_blank" variant="caption" color="text.primary">
          Support
