...
class ApiProvider {
  // Use 192.168.1.8 for Android emulator, 192.168.1.8 for iOS simulator
  static String get baseUrl {
    if (GetPlatform.isAndroid) {
      // Android Emulator maps 192.168.1.8 to host 192.168.1.8
      return 'http://192.168.1.8:3000';
    }
    // iOS Simulator / Web uses 192.168.1.8 (or Cloud IP)
    return 'http://192.168.1.8:3000';
  }
