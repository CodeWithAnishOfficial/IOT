  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Obx(
          () => Text(
            controller.searchMode.value == 'explore' ? "Search Location" : "Set a Trip",
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      onTap: () => controller.onPlaceSelected(placeId, description),
                    );
                  },
                );
              }
                ...
                Expanded(
                  child: InkWell(
                    ...
                    child: const Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(Icons.map_outlined, color: Colors.black54, size: 20),
                        SizedBox(width: 8),
                        Text(
                          "Locate on map",
                          style: TextStyle(
    ...
    return Container(
      ...
      child: Focus(
        onFocusChange: (hasFocus) {
          if (hasFocus) {
            this.controller.activeField.value = isSource ? 'source' : 'destination';
