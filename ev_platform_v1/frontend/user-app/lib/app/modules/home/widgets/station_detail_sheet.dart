...
class StationDetailSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        color: theme.cardColor, // Updated to cardColor for proper elevation in Dark Mode
                          ...
                          ? Image.network(
                              ...
                              errorBuilder: (context, error, stackTrace) {
                                 return Container(
                                   ...
                                   child: Center(
                                     child: Icon(Icons.ev_station_rounded, size: 80, color: theme.iconTheme.color?.withOpacity(0.5)),
                                   ),
                                 );
                              },
                            )
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Icon(Icons.ev_station, size: 20, color: theme.iconTheme.color?.withOpacity(0.5)),
                      ...
                      if (station.facilities.isNotEmpty) ...[
                        Row(
                          children: [
                            Icon(Icons.stars_rounded, size: 20, color: theme.iconTheme.color?.withOpacity(0.5)),
                            const SizedBox(width: 8),
                            Text(
                              "Amenities",
                              style: theme.textTheme.titleMedium?.copyWith(
                        ...
                        Wrap(
                          spacing: 12,
                          runSpacing: 12,
                          children: station.facilities.map((f) => _buildAmenityChip(context, f)).toList(),
                        ),
          ...
          Positioned(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Icon(Icons.close, color: theme.iconTheme.color, size: 22),
              ),
            ),
          ),
              ...
              child: SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    foregroundColor: theme.colorScheme.onPrimary, // Text on Lime
                    elevation: 0,
  ...
  Widget _buildConnectorCard(BuildContext context, Connector connector, {bool isSelected = false, VoidCallback? onTap}) {
    final theme = Theme.of(context);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: theme.textTheme.bodySmall?.color, fontSize: 13), // Fixed visibility
                  ),
                ],
              ),
            ),
  ...
  Widget _buildAmenityChip(BuildContext context, String name) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: theme.cardColor, // Dark bg instead of white
        borderRadius: BorderRadius.circular(20),
        border: Border.all(color: theme.dividerColor),
      ),
      child: Row(
        ...
        children: [
          Icon(icon, size: 16, color: theme.iconTheme.color?.withOpacity(0.7)), // Light icon
