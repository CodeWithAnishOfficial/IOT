        ...
        try {
            ...
            switch (action) {
                ...
                case 'TransactionEvent':
                    responsePayload = await Handlers.handleTransactionEvent(connection, payload);
                    break;
                default:
