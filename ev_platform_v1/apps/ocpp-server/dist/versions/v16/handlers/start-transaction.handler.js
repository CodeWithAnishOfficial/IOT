...
const smart_charging_service_1 = require("../../../services/smart-charging.service");
const logger = new shared_1.Logger('StartTransactionHandler');
async function handleStartTransaction(connection, payload) {
    ...
    const pendingSession = await shared_1.ChargingSession.findOne({
    ...
    smart_charging_service_1.SmartChargingService.applyLoadBalancing(connection, connectorId).catch(err => {
